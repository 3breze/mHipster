package com.oul.mHipster.todelete;

import com.oul.mHipster.model.Entity;
import com.squareup.javapoet.TypeSpec;

public class OldShitModel {
    ...
    public static class EntityModelBuilder {
        ...
        public OldShitModel build() {
            OldShitModel oldShitModel = new OldShitModel();
            oldShitModel.setClassName(className);
            oldShitModel.setInstanceName(instanceName);
            oldShitModel.setRequestDtoClassName(requestDtoClassName);
            oldShitModel.setRequestDtoInstanceName(requestDtoInstanceName);
            oldShitModel.setResponseDtoClassName(responseDtoClassName);
            oldShitModel.setResponseDtoInstanceName(responseDtoInstanceName);
            oldShitModel.setTypeSpec(typeSpec);
            oldShitModel.setLayer(layer);
            oldShitModel.setPackageName(packageName);
            oldShitModel.setEntity(entity);
            return oldShitModel;
        }
    }
}
